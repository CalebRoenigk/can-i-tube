...
function devConsoleInt() {
  ...
  devConsoleContentArea.append(devConsoleTitle).append(devConsoleInstruction).append(devConsoleTime); // Add the Cookie wrapper and actions wrapper
  ...
  (0, _jquery.default)('#dev-console-items').append(cookieWrapper).append(actionsWrapper); // Add actions to the actions wrapper

  (0, _jquery.default)('#dev-console-actions').append('<div id="actions-title">ACTIONS\n<span class="dev-console-subtitle">Warning: these actions cannot be undone.</span></div>').append('<div class="actions-item" id="clear-settings">Clear Settings</div>').append('<div class="actions-item" id="clear-all-rivers">Clear All River Data</div>').append('<div class="actions-item" id="factory-reset">Factory Reset & Reload</div>'); // Start running the time function for the console
